...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["Missing Raid Buffs - Fury Warrior (H)"] = {
			...
			["xOffset"] = -622.7758483886719,
			["preferToUpdate"] = false,
			["yOffset"] = -279.2861633300781,
			["anchorPoint"] = "CENTER",
			["borderColor"] = {
				1, -- [1]
				1, -- [2]
		...
		["狂暴戰"] = {
			["controlledChildren"] = {
				...
				"Flurry - Buff 2", -- [32]
				"Execute - Usable 3", -- [33]
				"Execute - Usable (Defensive) 3", -- [34]
				"Recklessness - Buff 2", -- [35]
			},
			["borderBackdrop"] = "Blizzard Tooltip",
			["wagoID"] = "jMHRj-FSb",
			["authorOptions"] = {
	...
	["frame"] = {
		["xOffset"] = -102.2249755859375,
		["yOffset"] = -433.0554809570313,
