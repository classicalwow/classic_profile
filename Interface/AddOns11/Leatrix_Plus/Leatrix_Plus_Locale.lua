...
L["If checked, you will be able to pan (right-button) and zoom (mousewheel) in the character frame, dressup frame and inspect frame.|n|nYou will be able to middle-click the character model in the character frame to toggle character attributes.|n|nModel rotation controls will be hidden.  Buttons to toggle gear will be added to the dressup frame."] = "Si está seleccionado, podrá desplazarse (botón derecho) y hacer zoom (rueda del ratón) en el marco del personaje, el marco del probador y el marco de inspección.|n|nPodrás hacer clic con el botón central en el modelo del personaje en el marco del personaje para alternar los atributos del personaje.|n|nLos controles de rotación del modelo estarán ocultos. Los botones para alternar el equipo se agregarán al marco del probador."
...
L["If checked, you will be able to pan (right-button) and zoom (mousewheel) in the character frame, dressup frame and inspect frame.|n|nYou will be able to middle-click the character model in the character frame to toggle character attributes.|n|nModel rotation controls will be hidden.  Buttons to toggle gear will be added to the dressup frame."] = "Si cette option est cochée, vous pourrez effectuer un panoramique (bouton droit) et un zoom (molette de la souris) dans le cadre du personnage, le cadre de la cabine d'essayage et d'inspection.|n|nVous pourrez cliquer avec le bouton central sur le modèle de personnage dans le cadre du personnage pour basculer les attributs du personnage.|n|nLes commandes de rotation du modèle seront masquées. Des boutons pour basculer l'équipement seront ajoutés au cadre de la cabine d'essayage."
...
L["If checked, you will be able to pan (right-button) and zoom (mousewheel) in the character frame, dressup frame and inspect frame.|n|nYou will be able to middle-click the character model in the character frame to toggle character attributes.|n|nModel rotation controls will be hidden.  Buttons to toggle gear will be added to the dressup frame."] = "Se marcado, você será capaz de deslocar (botão direito) e zoom (roda do mouse) no quadro do personagem, quadro de provador e inspecionar quadro.|n|nVocê será capaz de clicar com o botão do meio no modelo do personagem no quadro do personagem para alternar os atributos do personagem.|n|nOs controles de rotação do modelo serão ocultados. Botões para alternar a engrenagem serão adicionados ao quadro de provador."
