...
--	spell_table
	spell_id_table["Water"] = {5504, 5505, 5506, 6127, 10138, 10139, 10140};
	spell_id_table["Food"] = {587, 597, 990, 6129, 10144, 10145, 28612};
	if UnitFactionGroup("player") == "Alliance" then
		spell_id_table["Teleports"] = { 3565, 3561, 3562, };
		spell_id_table["Portals"] = { 11419, 10059, 11416, };
	else
		spell_id_table["Teleports"] = { 3566, 3563, 3567, };
		spell_id_table["Portals"] = { 11420, 11418, 11417, };
	end
	spell_id_table["Gems"] = { 759, 3552, 10053, 10054, };
