U1RegisterAddon("TrinketMenu", {
    ...
    tags = { "TAG_COMBATINFO", },
    icon = [[Interface\Addons\TrinketMenu\Textures\TrinketMenu-Icon-Up]],
    desc = "显示两个饰品按钮，可以快速选择饰品。`左键点击装备到第一个饰品栏，右键点击装备到第二个饰品栏`右键点击小地图按钮可以打开配置窗口（快捷命令为/trinketmenu opt），可以配置自动更换饰品及各个饰品的优先级，每次脱离战斗好，插件会判断饰品是否可用，智能更换饰品。`按住Alt点击饰品按钮可以快速设置是否自动更换。",
