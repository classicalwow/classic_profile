...
local m2_idx = {
	...
	{ 165855, "spells\\curseofrecklessness_impact_chest.m2", false, 1.0, { 2.250, 0.000, 1.000, 0.000, }, 0.0, 0.0, 0.0, 0.1, },
	...
	{ 166497, "spells\\lightningbolt_missile.m2", false, 1.0, { 4.000, 0.000, 1.800, 0.000, }, 0.0, 0.0, 0.0, 0.1, },
...
function _G.__163_HookCastingBarFrame(frame, idx)
	frame = frame or CastingBarFrame;
	hook(frame, idx);
end
function _G.__163_UnhookCastingBarFrame(frame)
	frame = frame or CastingBarFrame;
	unhook(frame);
end
