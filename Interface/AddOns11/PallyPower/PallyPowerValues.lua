...
do		--	163cust
	PALLYPOWER_DEFAULT_VALUES.profile.auras = true;
	PALLYPOWER_DEFAULT_VALUES.profile.rfbuff = true;
	if PALLYPOWER_DEFAULT_VALUES.profile.autobuff then
		PALLYPOWER_DEFAULT_VALUES.profile.autobuff.autobutton = true;
	end
	if PALLYPOWER_DEFAULT_VALUES.profile.display then
		PALLYPOWER_DEFAULT_VALUES.profile.display.showClassButtons = true;
		PALLYPOWER_DEFAULT_VALUES.profile.display.enableDragHandle = true;
	end
	PALLYPOWER_OTHER_VALUES.profile.auras = true;
	PALLYPOWER_OTHER_VALUES.profile.rfbuff = true;
	if PALLYPOWER_OTHER_VALUES.profile.autobuff then
		PALLYPOWER_OTHER_VALUES.profile.autobuff.autobutton = true;
	end
	if PALLYPOWER_OTHER_VALUES.profile.display then
		PALLYPOWER_OTHER_VALUES.profile.display.showClassButtons = true;
		PALLYPOWER_OTHER_VALUES.profile.display.enableDragHandle = true;
	end
end
