...
movableFrames = {
	GameMenuFrame, QuestFrame, FriendsFrame, GossipFrame,
	DressUpFrame, AddonList, MerchantFrame, HelpFrame,
	MailFrame, BankFrame, VideoOptionsFrame, InterfaceOptionsFrame,
	PVEFrame, LootFrame, RaidBrowserFrame, TradeFrame,
	TradeFrame, RaidBrowserFrame, QuestLogPopupDetailFrame, SUFWrapperFrame,
	TalkingHeadFramem, WorldMapFrame, ChatConfigFrame, BattlefieldFrame,
}
...
movableFramesWithhandle = { ["CharacterFrame"] =  { PaperDollFrame, ReputationFrame, SkillFrame, HonorFrame, PetPaperDollFrameCompanionFrame } ,
