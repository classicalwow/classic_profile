...
local _GetDatabaseDefaults = Addon.GetDatabaseDefaults;
Addon.GetDatabaseDefaults = function(self) local def = _GetDatabaseDefaults(self); def.profile.ab.rightClickUnit = nil; return def; end
