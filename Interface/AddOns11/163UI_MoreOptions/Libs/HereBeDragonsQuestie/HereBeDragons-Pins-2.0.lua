...
local MAJOR, MINOR = "HereBeDragonsQuestie-Pins-2.0", 999908
...
for index = 1, #_method do
    local k = _method[index];
    _method[k] = worldmapProvider[k];
    worldmapProvider[k] = _noop;
end
