...
ShowMeMyHealIconDB = LibStub("LibDataBroker-1.1"):NewDataObject("治疗数值显示图标", {
    type = "data source",
    text = "治疗数值显示",
...
function ShowMeMyHeal:CreateUI()
    ...
    local function CreateMinimapMenu(container)
        ...
        ShowMeMyHeal.SettingsUI.checkboxMinimap:SetLabel("隐藏小地图按钮")
    ...
    local function CreateButtonMenu(container)
        ...
        ShowMeMyHeal.SettingsUI.buttonReset:SetText("重置以上设定")
        ...
        ShowMeMyHeal.SettingsUI.buttonTest:SetText("测试以上设定")
    ...
    local function CreateColorMenu(container)
        ...
        ShowMeMyHeal.SettingsUI.ColorPickerNormalHeal:SetLabel("正常治疗")
        ...
        ShowMeMyHeal.SettingsUI.ColorPickerCritHeal:SetLabel("暴击治疗")
        ...
        ShowMeMyHeal.SettingsUI.ColorPickerExcessHeal:SetLabel("过量治疗")
        ...
        ShowMeMyHeal.SettingsUI.ColorPickerName:SetLabel("名字")
    ...
    local function CreateFontMenu(container)
        ...
        ShowMeMyHeal.SettingsUI.SliderNormalHeal:SetLabel("治疗数值字体大小")
        ...
        ShowMeMyHeal.SettingsUI.SliderCritHeal :SetLabel("暴击治疗数值字体大小")
    ...
    local function createShowMenu(container)
        ...
        ShowMeMyHeal.SettingsUI.CheckboxHOTs:SetLabel("持续治疗")
        ...
        ShowMeMyHeal.SettingsUI.CheckboxTargetHealName:SetLabel("显示治疗者姓名")
        ...
        ShowMeMyHeal.SettingsUI.CheckboxVampiricEmbrace:SetLabel("(牧师) 吸血鬼的拥抱")
        ...
        ShowMeMyHeal.SettingsUI.CheckboxShowAllPLayersWhoAreHealing:SetLabel("显示所有治疗者 (包含NPC)")
        ...
        ShowMeMyHeal.SettingsUI.CheckboxOverheal:SetLabel("显示过量治疗,当超过X点")
        ...
        ShowMeMyHeal.SettingsUI.CheckboxZeroHeal:SetLabel("显示治疗量为0的数值")
        ...
        ShowMeMyHeal.SettingsUI.CheckboxSelfHeal:SetLabel("自疗")
    ...
    local function createAnimationMenu(container)
        ...
        ShowMeMyHeal.SettingsUI.SliderScrollLength:SetLabel("滚动长度")
        ...
        ShowMeMyHeal.SettingsUI.SliderOffsetX:SetLabel("横向X轴位置")
        ...
        ShowMeMyHeal.SettingsUI.SliderOffsetY:SetLabel("纵向Y轴位置")
