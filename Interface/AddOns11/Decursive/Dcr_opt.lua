                ...
                args = {
                    ...
                    Title = {
                        ...
                        name = (
                                    ...
                                    "2.7.8.4", "John Wellesz", ("2021-11-11T17:02:56Z"):sub(1,10),
                                    L["ABOUT_NOTES"],
...
T._LoadedFiles["Dcr_opt.lua"] = "2.7.8.4";

-- Closer

--  HACKED BY ALA   --  FUCKING DECURSIVE, MIND UR OWN BUSINESS
local GDS = D.GetDefaultsSettings;
function D:GetDefaultsSettings()
    local def = GDS(self);
    def.global.NoStartMessages = false;
    def.profile.HideLiveList = true;
    def.profile.Print_CustomFrame = false;
    def.profile.PlaySound = false;
    def.profile.Print_Error = false;
    def.profile.Print_ChatFrame = false;
    return def;
end
