...
elseif (GetLocale() == "zhTW") then
	...
	MOGUBAR_WINDOWS_WINDOWS = "Window";
	MOGUBAR_WINDOWS_UNLOCK_BAR = "Unlock";
	MOGUBAR_WINDOWS_LOCK_BAR = "Lock";
	MOGUBAR_WINDOWS_MINIMIZE_BAR = "Minimize";
	MOGUBAR_WINDOWS_RESTORE_BAR = "Restore";
	MOGUBAR_WINDOWS_RESIZE = "Resize Bar";
	MOGUBAR_WINDOWS_CLOSE_BAR = "Close";
	MOGUBAR_WINDOWS_ARRANGEMENT = "Arrangement";
	MOGUBAR_WINDOWS_ARRANGEMENT_HORIZONTAL = "Horizontal arrangement";
	MOGUBAR_WINDOWS_ARRANGEMENT_VERTICAL = "Vertical arragnement";
	MOGUBAR_WINDOWS_ARRANGEMENT_FUNNY = "Funny arrangement";
	MOGUBAR_WINDOWS_BUTTONS = "Button";
	MOGUBAR_WINDOWS_INCREASE_BUTTON = "Increase button";
	MOGUBAR_WINDOWS_DECREASE_BUTTON = "Decrease button";
	MOGUBAR_WINDOWS_OTHERS = "Other";
	MOGUBAR_WINDOWS_CREATE_NEW_BAR = "Create new bar";
	MOGUBAR_WINDOWS_MESSAGE_ERROR_NO_ENOUGH_ID = "No more button could be arragned.";
    MOGUBAR_WINDOWS_CLOSE_BAR_INFO = "All button information you want to close will be lost, do you really want to do?";
    MOGUBAR_ENABLE = "Enable MOGU Bar";
	MOGUBAR_WINDOWS_RESET = "Key Binding";
	MOGUBAR_WINDOWS_HIDE_TAB = "Hide action bar headers";
	MOGUBAR_WINDOWS_HIDE_GRID = "Hide unused action buttons";
	MOGUBAR_WINDOWS_TAB_HELP_TEXT = "Hold mouse left button to move bar,\nRight click to popup menu.";
end
local MOGUBar_MAX_BUTTONS = 12;
local MOGUBar_13a3c67ee59d2b4a6a40c57847c95a42 = 1;
local U1BAR_DEFAULT_BTNS = 10;
local MOGUBar_72be2d2fba590211fe0f29e1a9832788 = 124;
local U1BAR_MAX_BARS = 10;
local MOGUBar_3062be796f02383eadecd6c8e48ebc4b = nil;
local MOGUBar_f97a2a7812f94d4bb34fcf1f04f5711e = nil;
...
function MOGUBar_TabDropDownInitialize(frame, level)
    ...
    if (currBar and not currBar.minimized) then
        ...
        if (MOGUBar_b740f76b158bf0246affe3865ebde2cf(currBar) < MOGUBar_MAX_BUTTONS) then
        ...
        MOGUBar_info.disabled = 1;
        if (MOGUBar_b740f76b158bf0246affe3865ebde2cf(currBar) > MOGUBar_13a3c67ee59d2b4a6a40c57847c95a42) then
            MOGUBar_info.disabled = nil;
        end
        UIDropDownMenu_AddButton(MOGUBar_info);
    end
