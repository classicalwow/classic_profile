...
addon_data.player.InitializeVisuals = function()
    ...
    frame.main_left_text:SetFont("Fonts/ARKai_T.ttf", 10)
    ...
    frame.main_right_text:SetFont("Fonts/ARKai_T.ttf", 10)
    ...
    frame.off_left_text:SetFont("Fonts/ARKai_T.ttf", 10)
    ...
    frame.off_right_text:SetFont("Fonts/ARKai_T.ttf", 10)
...
addon_data.player.CreateConfigPanel = function(parent_panel)
    ...
    -- Title Text
    panel.title_text = addon_data.config.TextFactory(panel, "玩家攻击计时条设置", 20)
