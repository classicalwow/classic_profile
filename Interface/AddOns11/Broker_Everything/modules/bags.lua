...
local function sortBags(a,b)
	local a1,a2 = strsplit(":",a); a = (tonumber(a1) or 0)*100+(tonumber(a2) or 0);
	local b1,b2 = strsplit(":",b); b = (tonumber(b1) or 0)*100+(tonumber(b2) or 0);
	return a < b;
end
...
module.config_defaults.enabled = false;
