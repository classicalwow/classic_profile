...
module_sys.config_defaults.enabled = false;
module_fps.config_defaults.enabled = false;
module_lat.config_defaults.enabled = false;
module_mem.config_defaults.enabled = false;
module_traf.config_defaults.enabled = false;
