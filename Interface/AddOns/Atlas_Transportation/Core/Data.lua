-- $Id: Data.lua 179 2022-07-27 14:58:40Z arithmandar $
--[[
...
--[[
		...
		TransAllianceWest = {
			...
			{ PURP.." D') "..BZ["The Stair of Destiny"]..ALC["Comma"]..BZ["Hellfire Peninsula"]..ALC["Comma"]..BZ["Outland"] },
			{ PURP.." E') "..BZ["Stormwind Harbor"]..ALC["Comma"]..BZ["Elwynn Forest"]..ALC["Comma"]..BZ["Eastern Kingdoms"] },
			{ ORNG.." F') "..BZ["Boralus Harbor"]..ALC["Comma"]..BZ["Tiragarde Sound"]..ALC["Comma"]..BZ["Kul Tiras"] },
...
--			{ "K", 10013, 441, 169, 736, 240, "Purple" }, -- Dalaran
	...
	horde.maps = {
		...
		TransHordeEast = {
			...
			{ "" },
			{ BLUE..BZ["Gilneas"] },
			{ WHIT.."25) "..BZ["Forsaken Forward Command"] },
			{ "" },
			{ BLUE..BZ["Hillsbrad Foothills"] },
			{ WHIT.."26) "..BZ["Southpoint Gate"] },
			{ WHIT.."27) "..BZ["Ruins of Southshore"] },
			{ WHIT.."28) "..BZ["Eastpoint Tower"] },
			{ WHIT.."29) "..BZ["Tarren Mill"] },
			{ WHIT.."30) "..BZ["Strahnbrad"] },
			{ "" },
			{ BLUE..BZ["Arathi Highlands"] },
			{ WHIT.."31) "..BZ["Galen's Fall"] },
			{ WHIT.."32) "..BZ["Hammerfall"] },
			{ "" },
			{ BLUE..BZ["The Hinterlands"] },
			{ WHIT.."33) "..BZ["Hiri'watha Research Station"] },
			{ WHIT.."34) "..BZ["Revantusk Village"] },
			{ "" },
			{ BLUE..BZ["Twilight Highlands"] },
