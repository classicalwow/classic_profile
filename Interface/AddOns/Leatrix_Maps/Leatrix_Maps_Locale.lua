...
L["If checked, the battlefield map will stay centered on your location as long as you are not dragging the map or in a dungeon."] = "勾选后，战场地图会根据你的位置来居中显示，除非你拖动它或者处于地下城。"
...
L["If checked, the map will stay centered on your location as long as you are not dragging the map or in a dungeon."] = "勾选后，世界地图会根据你的位置来居中显示，除非你拖动它或者处于地下城。"
...
L["If checked, the battlefield map will stay centered on your location as long as you are not dragging the map or in a dungeon."] = "Если установлен этот флажок, то карта поля боя будет оставаться отцентрирована по вашему расположению так долго, пока вы её не переместите или не войдёте в подземелье."
...
L["If checked, the map will stay centered on your location as long as you are not dragging the map or in a dungeon."] = "Если установлен этот флажок, ваш персонаж будет находиться всегда в центре карты и до тех пор, пока вы не переместите карту вручную или не войдёте в подземелье."
