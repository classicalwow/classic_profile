-------------------------------------------------------------------------------
--|> PixelUtil
--: From retail's exported code
--: WHY WOULD YOU REMOVE A STANDALONE, HELPFUL FUNCTION LIKE THIS???!?!?
-------------------------------------------------------------------------------
--|> UPVALUE GLOBALS
-------------------------------------------------------------------------------
local weizPVP = _G.weizPVP
_G.weizPVP.PixelUtil = {}
...
function PixelUtil.SetStatusBarValue(statusBar, value)
    ...
    if width and width > 0.0 then
        ...
        if percent == 0.0 or percent == 1.0 then
            ...
            local numPixels =
                PixelUtil.GetNearestPixelSize(statusBar:GetWidth() * percent, statusBar:GetEffectiveScale())
