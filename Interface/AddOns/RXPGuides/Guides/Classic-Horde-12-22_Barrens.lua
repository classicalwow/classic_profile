...
step << Tauren Shaman
    ...
    .accept 840 >>接受|cFFFCDC00部落的新兵|r
step << Tauren Shaman
    #completewith next
...
step << Tauren Shaman
    ...
    .turnin 840 >>提交|cFF00FF25部落的新兵|r
    .accept 842 >>接受|cFFFCDC00十字路口征兵|r
step << Warrior
    #completewith next
...
step << Warrior
    ...
    .turnin 1502 >>提交|cFF00FF25索恩格瑞姆·火眼|r
    .accept 1503 >>接受|cFFFCDC00锻造好的钢锭|r
step << Warrior
    >>掠夺灰色箱子以获得锻钢棒
...
step << Warrior
    .goto The Barrens,57.2,30.3
    .turnin 1503 >>提交|cFF00FF25锻造好的钢锭|r
step << Shaman
    #sticky
    >>杀死并掠夺剃须刀以获取火油
...
step << !Shaman !Warrior/Undead
    ...
    .turnin 842 >>提交|cFF00FF25十字路口征兵|r
    .accept 844 >>接受|cFFFCDC00平原陆行鸟的威胁|r
step << !Shaman !Warrior/Undead
    .goto The Barrens,52.2,31.8
    .accept 870 >>接受|cFFFCDC00遗忘之池|r
step << Orc !Warrior !Shaman/Troll !Warrior !Shaman
    .goto The Barrens,52.5,29.8
    .accept 6365 >>接受|cFFFCDC00送往奥格瑞玛的肉|r
step << Shaman Troll/Shaman Orc/Warrior Orc/Warrior Troll/Rogue Orc/Rogue Troll
    .goto The Barrens,52.62,29.84
    .turnin 6386 >>提交|cFF00FF25返回十字路口|r
step << Undead
    .goto The Barrens,51.99,29.89
	.home >>把炉子放在十字路口
step << !Shaman !Warrior/Undead
    .goto The Barrens,51.9,30.3
    .accept 869 >>接受|cFFFCDC00偷钱的迅猛龙|r
step << !Shaman !Warrior/Undead
    .goto The Barrens,51.5,30.8
    .accept 871 >>接受|cFFFCDC00野猪人的袭击|r
    .accept 5041 >>接受|cFFFCDC00十字路口的补给品|r
step << !Shaman !Warrior/Undead
	#completewith next
...
step << Orc !Warrior !Shaman/Troll !Warrior !Shaman
    ...
    .turnin 6365 >>提交|cFF00FF25送往奥格瑞玛的肉|r
    .accept 6384 >>接受|cFFFCDC00飞往奥格瑞玛|r
step << !Shaman
	#era/som
    .goto The Barrens,51.5,30.1
    .accept 848 >>接受|cFFFCDC00菌类孢子|r
    .accept 1492 >>接受|cFFFCDC00码头管理员迪兹维格|r
	.turnin 1358 >>提交|cFF00FF25给赫布瑞姆的样本|r
step << !Shaman
	#som
	#phase 3-6
    .goto The Barrens,51.5,30.1
...
step
    ...
    .accept 819 >>接受|cFFFCDC00老陈的空酒桶|r
step
...
step << !Tauren !Undead
    ...
    .turnin 926 >>提交|cFF00FF25有瑕疵的能量石|r
...
step
    ...
    .turnin 871 >>提交|cFF00FF25野猪人的袭击|r
    .accept 872 >>接受|cFFFCDC00野猪人的头目|r
step
#era/som
    .goto The Barrens,51.62,30.90
    >>跑到塔顶
    .accept 867 >>接受|cFFFCDC00鹰身强盗|r
step
    .goto The Barrens,52.2,31.0
    .turnin 844 >>提交|cFF00FF25平原陆行鸟的威胁|r
    .accept 845 >>接受|cFFFCDC00斑马的威胁|r
step << Tauren Shaman
    .goto The Barrens,52.2,31.0
    .turnin 842 >>提交|cFF00FF25十字路口征兵|r
step << Warrior
...
step << !Tauren !Undead
    ...
    .turnin 924 >>提交|cFF00FF25恶魔之种|r
step << Shaman
    .goto Durotar,38.5,58.9
    .turnin 1525 >>提交|cFF00FF25火焰的召唤|r
    .accept 1526 >>接受|cFFFCDC00火焰的召唤|r
step << Shaman
    >>跑到山顶。单击钎焊器
...
step << Shaman
    ...
    .turnin 1526 >>提交|cFF00FF25火焰的召唤|r
    .accept 1527 >>接受|cFFFCDC00火焰的召唤|r
step << Shaman
    #sticky
    #completewith next
    >>杀死你看到的任何哲夫拉。抢走他们的马蹄
...
step << Shaman
    ...
    .turnin 1527 >>提交|cFF00FF25火焰的召唤|r
step << Shaman
     >>在这里掠夺酒桶。如果还没有结束，等待重生
    .goto The Barrens,55.8,20.0
    .collect 4926,1,819 --Collect Chen's Empty Keg
...
step
    ...
    .accept 887 >>接受|cFFFCDC00南海海盗|r
step
    .goto The Barrens,63.1,37.1
    .fp Ratchet >>获取棘轮飞行路径
step
    .goto The Barrens,63.0,37.2
    .accept 894 >>接受|cFFFCDC00什么什么平衡器|r
step
    >>单击通缉海报。如果你想，也可以在这里存款
    .goto The Barrens,62.6,37.5
    .accept 895 >>接受|cFFFCDC00通缉：巴隆·朗绍尔|r
step
    .goto The Barrens,62.4,37.7
    .accept 865 >>接受|cFFFCDC00迅猛龙角|r
step << Rogue
    .goto The Barrens,62.2,37.4
	.vendor	>>去Ironzar买1-2把弯刀(如果它们比你现在的武器好的话)
step
    .goto The Barrens,62.3,38.4
    .turnin 819 >>提交|cFF00FF25老陈的空酒桶|r
    .accept 821 >>接受|cFFFCDC00老陈的空酒桶|r
step
    #sticky
    #label Southsea
    >>杀死该地区的南海暴徒
...
step
    #requires Southsea
    .goto The Barrens,62.7,36.3
    .turnin 887 >>提交|cFF00FF25南海海盗|r
    .accept 890 >>接受|cFFFCDC00丢失的货物|r
    .turnin 895 >>提交|cFF00FF25通缉：巴隆·朗绍尔|r
step << Rogue
	.goto The Barrens,62.2,37.4
	.vendor	>>去Ironzar买1-2把弯刀(如果它们比你现在的武器好的话)
step << Shaman
...
step
    ...
    .turnin 1492 >>提交|cFF00FF25码头管理员迪兹维格|r
    .turnin 890 >>提交|cFF00FF25丢失的货物|r
    .accept 892 >>接受|cFFFCDC00丢失的货物|r
    .accept 896 >>接受|cFFFCDC00矿工的宝贝|r
step
    .goto The Barrens,62.7,36.3
    .turnin 892 >>提交|cFF00FF25丢失的货物|r
    .accept 888 >>接受|cFFFCDC00被窃的货物|r
step << !Warrior
...
step
    .goto The Barrens,52.2,31.0
    .turnin 845 >>提交|cFF00FF25斑马的威胁|r
    .accept 903 >>接受|cFFFCDC00草原上的徘徊者|r
step
    .goto The Barrens,51.5,30.8
    .turnin 5041 >>提交|cFF00FF25十字路口的补给品|r
    .turnin 872 >>提交|cFF00FF25野猪人的头目|r
step << Hunter
...
step << !Undead !Rogue
    ...
    .accept 850 >>接受|cFFFCDC00科卡尔首领|r
    .accept 855 >>接受|cFFFCDC00半人马护腕|r
step << !Undead !Rogue
	#som
    .goto The Barrens,45.4,28.4
    .accept 850 >>接受|cFFFCDC00科卡尔首领|r
...
step << !Undead !Rogue
   ...
   .turnin 850 >>提交|cFF00FF25科卡尔首领|r
    .accept 851 >>接受|cFFFCDC00狂热的维罗戈|r
step << !Undead !Rogue
	#era
	.isQuestComplete 855
    .goto The Barrens,45.39,28.44
    .turnin 855 >>提交|cFF00FF25半人马护腕|r
step
	#era
	#label Leaders
    .goto The Barrens,45.39,28.44
...
step
    ...
    .turnin 894 >>提交|cFF00FF25什么什么平衡器|r
    .accept 900 >>接受|cFFFCDC00什么什么平衡器|r
step
    >>点击阀门
...
step
    >>单击控制台
    .goto The Barrens,52.4,11.6
    .turnin 900 >>提交|cFF00FF25什么什么平衡器|r
    .accept 901 >>接受|cFFFCDC00什么什么平衡器|r
step
...
step
    .goto The Barrens,52.4,11.6
    .turnin 901 >>提交|cFF00FF25什么什么平衡器|r
    .accept 902 >>接受|cFFFCDC00什么什么平衡器|r
step
    #sticky
    #completewith next
    >>杀死平原漫游者。掠夺他们的肾脏
...
step
    >>这将开始护送。确保你完全健康
    .goto The Barrens,56.5,7.5
    .turnin 858 >>提交|cFF00FF25打火钥匙|r
    .accept 863 >>接受|cFFFCDC00梅贝尔的隐形水|r
step
    #label Slugs
...
step
    ...
    .accept 1061 >>接受|cFFFCDC00石爪之灵|r
step << Druid
    .goto Orgrimmar,54.2,68.4
	.fly Thunder Bluff >>飞向雷霆崖
step << !Rogue !Undead !Tauren !Shaman !Warrior
    .goto Orgrimmar,54.2,68.4
    .turnin 6384 >>提交|cFF00FF25飞往奥格瑞玛|r
    .accept 6385 >>接受|cFFFCDC00双足飞龙管理员多拉斯|r
step << !Rogue !Undead !Tauren !Shaman !Warrior
    .goto Orgrimmar,45.2,63.8
    .turnin 6385 >>提交|cFF00FF25双足飞龙管理员多拉斯|r
    .accept 6386 >>接受|cFFFCDC00返回十字路口|r
step << Rogue
    .goto Orgrimmar,43.05,53.73
>>学习职业技能	>>确保你已经训练过拾取锁定
    .accept 2379 >>接受|cFFFCDC00赞杜沙|r
	.turnin 1963 >>提交|cFF00FF25碎手氏族|r
--	.accept 1858 >>接受|cFFFCDC00碎手氏族|r
--N ..Make sure you train Pick Pocket
step << Rogue
    .goto Orgrimmar,42.72,52.95
    .turnin 2379 >>提交|cFF00FF25赞杜沙|r
    .accept 2382 >>接受|cFFFCDC00棘齿城的维尼克斯|r
step << skip
    >>客栈里的扒手游戏。打开你包里的泰山背包
...
step << skip
    .goto Orgrimmar,43.05,53.73
	.turnin 1858 >>提交|cFF00FF25碎手氏族|r
--N Rogue class q
step << Warlock
...
step << Druid
	...
	.accept 27 >>接受|cFFFCDC00必修的课程|r
step << Druid
    .zone Moonglade >>前往: |cFFDB2EEF月光林地|r
step << Druid
    >>楼上的
    .goto Moonglade,56.21,30.64
	.turnin 27 >>提交|cFF00FF25必修的课程|r
    .accept 28 >>接受|cFFFCDC00湖中试炼|r
step << Druid
    .goto Moonglade,52.53,40.56
>>学习职业技能step << Druid
    .goto Moonglade,36.52,40.10
    .turnin 28 >>提交|cFF00FF25湖中试炼|r
--    .accept 30 >>接受|cFFFCDC00海狮试炼|r
step
    #completewith next
    .hs >> 炉石回到旅店CD中就跑回去
step
    .goto The Barrens,51.9,30.3
    .turnin 869 >>提交|cFF00FF25偷钱的迅猛龙|r
    .accept 3281 >>接受|cFFFCDC00被偷走的银币|r
step
    .goto The Barrens,52.3,31.0
    .turnin 903 >>提交|cFF00FF25草原上的徘徊者|r
    .accept 881 >>接受|cFFFCDC00埃其亚基|r
step << !Rogue !Undead !Tauren !Shaman !Warrior
    .goto The Barrens,52.62,29.84
    .turnin 6386 >>提交|cFF00FF25返回十字路口|r
step
...
step
    .goto The Barrens,52.2,31.0
    .turnin 881 >>提交|cFF00FF25埃其亚基|r
    .accept 905 >>接受|cFFFCDC00狂暴的镰爪龙|r
step << !Warrior !Shaman
    .goto The Barrens,52.20,31.90
    .turnin 870 >>提交|cFF00FF25遗忘之池|r
    .accept 877 >>接受|cFFFCDC00死水绿洲|r
step
    .goto The Barrens,52.00,31.60
    .accept 899 >>接受|cFFFCDC00复仇的怒火|r
    .accept 4921 >>接受|cFFFCDC00在战斗中失踪|r
step
#era/som
    >>跑到塔顶
    .goto The Barrens,51.6,30.9
    .turnin 867 >>提交|cFF00FF25鹰身强盗|r
    .accept 875 >>接受|cFFFCDC00鹰身人首领|r
step << !Shaman !Warrior/Undead
    .goto The Barrens,51.50,30.20
    .turnin 848 >>提交|cFF00FF25菌类孢子|r
step
    .goto The Barrens,51.5,30.3
    .fly Ratchet >>飞到棘轮
step << Rogue
    .goto The Barrens,63.07,36.31
    .turnin 2382 >>提交|cFF00FF25棘齿城的维尼克斯|r
    .accept 2381 >>接受|cFFFCDC00抢劫海盗|r
step << Rogue
...
step
    .goto The Barrens,63.0,37.2
    .turnin 902 >>提交|cFF00FF25什么什么平衡器|r
    .turnin 863 >>提交|cFF00FF25梅贝尔的隐形水|r
    .accept 1483 >>接受|cFFFCDC00菲兹克斯|r
step << Hunter
    .goto The Barrens,63.0,37.2
    .accept 3921 >>接受|cFFFCDC00维妮·布特巴克|r
step
    .isQuestComplete 896
	.goto The Barrens,63.30,38.40
    .turnin 896 >>提交|cFF00FF25矿工的宝贝|r
step
    .abandon 896 >>如果你现在还没有放弃矿工的财富
step
    .goto The Barrens,62.40,37.70
    .accept 1069 >>接受|cFFFCDC00深苔蜘蛛的卵|r
step << Hunter
	#completewith next
...
step
    ...
    .accept 878 >>接受|cFFFCDC00野猪人的内战|r
step
    .goto The Barrens,44.5,59.2
...
step
    .goto The Barrens,51.9,30.3
    .turnin 3281 >>提交|cFF00FF25被偷走的银币|r
step
    .goto The Barrens,52.2,31.0
    .turnin 905 >>提交|cFF00FF25狂暴的镰爪龙|r
    .accept 3261 >>接受|cFFFCDC00乔恩·星眼|r
step
    .goto The Barrens,52.2,31.9
    .turnin 877 >>提交|cFF00FF25死水绿洲|r
    .accept 880 >>接受|cFFFCDC00变异的生物|r
step
    .goto The Barrens,52.0,31.6
    .turnin 4921 >>提交|cFF00FF25在战斗中失踪|r
step << Hunter
...
step << !Undead !Rogue
    ...
    .turnin 851 >>提交|cFF00FF25狂热的维罗戈|r
    .accept 852 >>接受|cFFFCDC00赫兹鲁尔·血印|r
step << Undead/Rogue
	#era
    .goto The Barrens,45.39,28.44
   .turnin 850 >>提交|cFF00FF25科卡尔首领|r
...
step << !Undead !Rogue
    ...
    .turnin 852 >>提交|cFF00FF25赫兹鲁尔·血印|r
step << !Undead !Rogue
	#era
	.isQuestTurnedIn 852
    .goto The Barrens,45.37,28.43
    .accept 4021 >>接受|cFFFCDC00人马无双！|r
step << !Undead !Rogue
	#era
    #softcore
	.isOnQuest 4021
...
step << !Undead !Rogue
    ...
    .goto The Barrens,45.39,28.44
    .turnin 4021 >>提交|cFF00FF25人马无双！|r
step
#era/som
    #sticky
    #completewith next
...
step
    ...
    .turnin 1061 >>提交|cFF00FF25石爪之灵|r
    .accept 1062 >>接受|cFFFCDC00地精侵略者|r
    .accept 6548 >>接受|cFFFCDC00为我的村庄复仇|r
]])
...
step
    ...
    .turnin 6548 >>提交|cFF00FF25为我的村庄复仇|r
    .accept 6629 >>接受|cFFFCDC00杀死格鲁迪格·暗云|r
step
    #sticky
    #completewith next
...
step
    ...
    .accept 6523 >>接受|cFFFCDC00保护卡雅|r
step
    #sticky
    #completewith next
    +3名暴徒在最后繁殖，小心
...
step
    ...
    .accept 6461 >>接受|cFFFCDC00盗窃的蜘蛛|r
step << Warlock
    >>点击通缉海报
...
step
    ...
    .turnin 1483 >>提交|cFF00FF25菲兹克斯|r
...
step
    ...
    .turnin 3261 >>提交|cFF00FF25乔恩·星眼|r
    .accept 882 >>接受|cFFFCDC00伊沙姆哈尔|r
step
...
step
	...
	.accept 883 >>接受|cFFFCDC00拉克塔曼尼|r
step
	#label QuillboarAndy
...
step << Rogue
   >>跑回棘轮
    .goto The Barrens,63.07,36.31
    .turnin 2381 >>提交|cFF00FF25抢劫海盗|r
step
.goto The Barrens,62.7,36.3
    >>跑回棘轮 << !Rogue
    .turnin 888 >>提交|cFF00FF25被窃的货物|r
step
    .goto The Barrens,63.0,37.2
    .turnin 1094 >>提交|cFF00FF25新的指示|r
    .accept 1095 >>接受|cFFFCDC00新的指示|r
step
    .goto The Barrens,62.4,37.6
    .turnin 865 >>提交|cFF00FF25迅猛龙角|r
    .turnin 1069 >>提交|cFF00FF25深苔蜘蛛的卵|r
step
    .goto The Barrens,62.3,38.4
    .turnin 821 >>提交|cFF00FF25老陈的空酒桶|r
step << Warrior
...
step
    .goto The Barrens,52.2,31.9
    .turnin 880 >>提交|cFF00FF25变异的生物|r
    .accept 1489 >>接受|cFFFCDC00哈缪尔·符文图腾|r
    .accept 3301 >>接受|cFFFCDC00茉拉·符文图腾|r
step
    .goto The Barrens,52.0,31.6
    .turnin 899 >>提交|cFF00FF25复仇的怒火|r
step
#era/som
    >>跑到塔顶
    .goto The Barrens,51.60,30.90
    .turnin 875 >>提交|cFF00FF25鹰身人首领|r
    .accept 876 >>接受|cFFFCDC00塞瑞娜·血羽|r
step << !Tauren !Shaman !Warrior
    >>这将启动定时任务
    .goto The Barrens,51.4,30.2
    .accept 853 >>接受|cFFFCDC00药剂师扎玛|r
step
    .goto The Barrens,51.5,30.3
...
step
    ...
    .turnin 878 >>提交|cFF00FF25野猪人的内战|r
    .accept 5052 >>接受|cFFFCDC00阿迦玛甘的血岩碎片|r
    .turnin 5052 >>提交|cFF00FF25阿迦玛甘的血岩碎片|r
...
step
    ...
    .turnin 883 >>提交|cFF00FF25拉克塔曼尼|r
    .isOnQuest 883
step
	.goto The Barrens,44.8,59.1
    .turnin 882 >>提交|cFF00FF25伊沙姆哈尔|r
    .accept 907 >>接受|cFFFCDC00被激怒的雷霆蜥蜴|r
    .accept 1130 >>接受|cFFFCDC00梅洛的关注|r
    .accept 6382 >>接受|cFFFCDC00灰谷狩猎|r
step
    #sticky
    #label Owatanka2
    #completewith next
...
step
    .goto The Barrens,44.9,59.1
    .turnin 907 >>提交|cFF00FF25被激怒的雷霆蜥蜴|r
    .accept 913 >>接受|cFFFCDC00雷鹰的嘶鸣|r
step
    .goto The Barrens,44.9,59.1
...
step
    .goto The Barrens,44.8,59.1
    .turnin 913 >>提交|cFF00FF25雷鹰的嘶鸣|r
    .accept 874 >>接受|cFFFCDC00玛伦·星眼|r
step << !Tauren !Warrior !Shaman
    #completewith next
    .goto The Barrens,44.54,59.27
    >>将你的血碎片交给来自芒果的风之精灵buff。如果意外出售了任何碎片，请跳过此步骤
    .turnin 889 >>提交|cFF00FF25风之魂|r
step << !Tauren !Warrior !Shaman
...
>>学习职业技能step << Warrior
    ...
    .accept 1823 >>接受|cFFFCDC00和鲁迦交谈|r
>>学习职业技能step << Druid
	#era
    .goto Thunder Bluff,77.0,29.9
	.trainer>>学习职业技能step << !Tauren !Warrior !Shaman
    #completewith next
...
step << !Tauren !Warrior !Shaman
    ...
    .accept 264 >>接受|cFFFCDC00至死方休|r
step << !Tauren !Warrior !Shaman
    .goto Thunder Bluff,23.00,21.00
    .turnin 853 >>提交|cFF00FF25药剂师扎玛|r
step << Priest
	#era
...
.trainer>>学习职业技能step << Shaman
	#som
    .goto Orgrimmar,37.95,37.73
	.accept 1528 >>接受|cFFFCDC00水之召唤|r
step << Warlock
	#som
    .goto Orgrimmar,48.15,45.28
    .accept 1507 >>接受|cFFFCDC00噬魂者|r
	.trainer>>学习职业技能step << Warlock
	#som
...
step << Warlock
    ...
    .turnin 1507 >>提交|cFF00FF25噬魂者|r
    .accept 1508 >>接受|cFFFCDC00盲眼卡祖尔|r
step << Warlock
	#som
    .goto Orgrimmar,37.26,59.63
    .turnin 1508 >>提交|cFF00FF25盲眼卡祖尔|r
    .accept 1509 >>接受|cFFFCDC00多格兰的消息|r
step << Warlock
	#som
...
step << Warlock
	#som
    .goto The Barrens,51.9,30.3
    .turnin 1509 >>提交|cFF00FF25多格兰的消息|r
    .accept 1510 >>接受|cFFFCDC00多格兰的消息|r
step
#era/som
...
step
    .goto The Barrens,35.3,27.9
    .turnin 1062 >>提交|cFF00FF25地精侵略者|r
    .turnin 6629 >>提交|cFF00FF25杀死格鲁迪格·暗云|r
    .turnin 6523 >>提交|cFF00FF25保护卡雅|r
    .accept 6401 >>接受|cFFFCDC00卡雅还活着|r
    .accept 1063 >>接受|cFFFCDC00长者|r
    .accept 1068 >>接受|cFFFCDC00伐木机|r
step << Warlock
	>>沿着左边的小路跑
    .goto Stonetalon Mountains,82.19,98.62,60,0
    .goto Stonetalon Mountains,75.77,97.32,60,0
    .goto Stonetalon Mountains,73.2,95.1
    .turnin 1510 >>提交|cFF00FF25多格兰的消息|r
    .accept 1511 >>接受|cFFFCDC00肯兹格拉的伤药|r
step
    ...
    .accept 1058 >>接受|cFFFCDC00金吉尔的森林魔法|r
	#era
step
    .goto Stonetalon Mountains,71.3,95.1
    .turnin 6461 >>提交|cFF00FF25盗窃的蜘蛛|r
step << Hunter
    >>点击通缉海报
    .goto Stonetalon Mountains,59.0,75.7
    .accept 6284 >>接受|cFFFCDC00贝瑟莱斯|r
...
step
    ...
    .accept 6562 >>接受|cFFFCDC00帮助耶努萨克雷|r
...
--    .accept 6301 >>接受|cFFFCDC00生生不息|r
    .turnin 6401 >>提交|cFF00FF25卡雅还活着|r
step
    .goto Stonetalon Mountains,59.0,62.6
    .turnin 1095 >>提交|cFF00FF25新的指示|r
step
	#era
    .unitscan XT:9
    >>杀死XT:9。它在河的南侧巡逻
...
step
    ...
    .accept 6641 >>接受|cFFFCDC00鞭笞者沃尔沙|r
step
	>>在Zoram'gar完成所有任务
    .goto Ashenvale,11.60,34.30
    .turnin 6562 >>提交|cFF00FF25帮助耶努萨克雷|r
    .accept 6442 >>接受|cFFFCDC00佐拉姆海岸的纳迦|r
    .accept 216 >>接受|cFFFCDC00蓟皮熊怪的麻烦|r
    .accept 6462 >>接受|cFFFCDC00巨魔符咒|r
...
step
    ...
    .turnin 6641 >>提交|cFF00FF25鞭笞者沃尔沙|r
step
    .goto Ashenvale,11.70,34.80
    .turnin 6442 >>提交|cFF00FF25佐拉姆海岸的纳迦|r
step << Druid
	#requires Vorsha
	>>使用“传送到月光”法术
    .goto Moonglade,52.5,40.5
...
step
    ...
    .turnin 1063 >>提交|cFF00FF25长者|r
    .accept 1064 >>接受|cFFFCDC00被遗忘者的援助|r
step
    .goto Thunder Bluff,78.62,28.56
    .turnin 1489 >>提交|cFF00FF25哈缪尔·符文图腾|r
    .accept 1490 >>接受|cFFFCDC00纳拉·蛮鬃|r
step
    .goto Thunder Bluff,75.65,31.62
    .turnin 1490 >>提交|cFF00FF25纳拉·蛮鬃|r
step << Tauren/Warrior/Shaman
	>>走进视野之池
...
step
   ...
   .turnin 1064 >>提交|cFF00FF25被遗忘者的援助|r
   .accept 1065 >>接受|cFFFCDC00塔伦米尔之旅|r
step << Priest
    .goto Thunder Bluff,25.4,15.0
	.accept 5644 >>接受|cFFFCDC00噬灵瘟疫|r
step << Shaman
    .goto Thunder Bluff,25.1,20.6
	.accept 1529 >>接受|cFFFCDC00水之召唤|r
step
...
step << Warlock
    ...
    .turnin 1511 >>提交|cFF00FF25肯兹格拉的伤药|r
    .accept 1515 >>接受|cFFFCDC00多格兰之囚|r
step << Warlock
	.goto The Barrens,43.3,47.9
    .turnin 1515 >>提交|cFF00FF25多格兰之囚|r
    .accept 1512 >>接受|cFFFCDC00爱的礼物|r
step << Warlock
...
#era/som
    .goto The Barrens,51.60,30.90
    .turnin 876 >>提交|cFF00FF25塞瑞娜·血羽|r
    .accept 1060 >>接受|cFFFCDC00写给金吉尔的信|r
step
    .goto The Barrens,51.10,29.60
    .accept 868 >>接受|cFFFCDC00蝎卵|r
step
    .goto The Barrens,51.50,30.87
    .accept 6541 >>接受|cFFFCDC00向卡德拉克报到|r
step << Hunter
    .goto The Barrens,49.00,11.20
    .turnin 3921 >>提交|cFF00FF25维妮·布特巴克|r
step
	>>去塔的二楼
    .goto The Barrens,48.12,5.42
    .turnin 6541 >>提交|cFF00FF25向卡德拉克报到|r
--    .accept 6543 >>接受|cFFFCDC00战歌报告|r
step << Hunter
...
step << Shaman
    ...
    .turnin 1528 >>提交|cFF00FF25水之召唤|r
step << Shaman
	#completewith next
    .goto The Barrens,65.8,43.8
    .turnin 1529 >>提交|cFF00FF25水之召唤|r
step << Shaman
	#label call
    .goto The Barrens,65.8,43.8
    .accept 1530 >>接受|cFFFCDC00水之召唤|r
...
step << Shaman
    ...
    .turnin 1530 >>提交|cFF00FF25水之召唤|r
    .accept 1535 >>接受|cFFFCDC00水之召唤|r
step << Shaman
    .goto The Barrens,44.1,76.9
    .complete 1535,1 --Filled Brown Waterskin (1)
step << Shaman
    .goto The Barrens,43.4,77.4
    .turnin 1535 >>提交|cFF00FF25水之召唤|r
    .accept 1536 >>接受|cFFFCDC00水之召唤|r
step << !Hunter !Mage
	#era/som
