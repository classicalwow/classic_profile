...
step <<  NightElf
    ...
    .turnin 6344 >>提交|cFF00FF25尼莎·影歌|r
    .accept 6341 >>接受|cFFFCDC00泰达希尔的渔业|r
step <<  NightElf
	>>与|cFF00FF25Vesprystus交谈|r
	.target Vesprystus
    .goto Teldrassil,58.39,94.01
    .turnin 6341 >>提交|cFF00FF25泰达希尔的渔业|r
    .accept 6342 >>接受|cFFFCDC00飞往奥伯丁|r
step <<  NightElf
     #completewith next
    .fly Auberdine >>飞到黑海岸
step <<  !NightElf
...
step
    .goto Felwood,19.10,20.63
    .accept 3524 >>接受|cFFFCDC00搁浅的巨兽|r
step <<  NightElf
    .goto Felwood,19.27,19.14
    .turnin 6342 >>提交|cFF00FF25飞往奥伯丁|r
    >>跳过跟进
step
...
step
    ...
    >>上楼去
    .accept 983 >>接受|cFFFCDC00传声盒827号|r
step
    .accept 2118 >>接受|cFFFCDC00瘟疫蔓延|r
    .goto Felwood,21.63,18.15
step
    .goto Felwood,22.24,18.22
    .accept 984 >>接受|cFFFCDC00熊怪的威胁|r
step <<  Dwarf Hunter
    #sticky
...
step
     .xp 12-1500 >>刷怪怪物直到你离12级1500 xp
step
    #requires crab1
    .goto Felwood,19.13,21.39
    >>单击Buzzbox
    .turnin 983 >>提交|cFF00FF25传声盒827号|r
step
	#era/som
	.goto Felwood,19.13,21.39
    .accept 1001 >>接受|cFFFCDC00传声盒411号|r
step
    .goto Felwood,19.10,20.63
    .turnin 3524 >>提交|cFF00FF25搁浅的巨兽|r
    .accept 4681 >>接受|cFFFCDC00搁浅的巨兽|r
step
    .goto Felwood,18.10,18.48
    .accept 963 >>接受|cFFFCDC00永志不渝|r
step
	#era/som
    #sticky
...
step
    #label washed1
    .goto Felwood,19.10,20.63
    .turnin 4681 >>提交|cFF00FF25搁浅的巨兽|r
step
    .goto Felwood,19.90,18.40
    .accept 947 >>接受|cFFFCDC00洞中的蘑菇|r
step
    .goto Felwood,20.34,18.12
    .accept 4811 >>接受|cFFFCDC00红色水晶|r
step
    .goto Felwood,21.63,18.15
    .turnin 2118 >>提交|cFF00FF25瘟疫蔓延|r
    .accept 2138 >>接受|cFFFCDC00清除疫病|r
step
    .goto Felwood,22.24,18.22
    .turnin 984 >>提交|cFF00FF25熊怪的威胁|r
    .accept 985 >>接受|cFFFCDC00熊怪的威胁|r
    .accept 4761 >>接受|cFFFCDC00桑迪斯·织风|r
step <<  Dwarf/Gnome/Human
    .goto Felwood,20.80,15.58
    .accept 982 >>接受|cFFFCDC00深不可测的海洋|r
step
    #completewith next
...
step
    .goto Felwood,19.98,14.40
    .turnin 4761 >>提交|cFF00FF25桑迪斯·织风|r
    .accept 4762 >>接受|cFFFCDC00壁泉河|r
    .accept 958 >>接受|cFFFCDC00上层精灵的工具|r
    .accept 954 >>接受|cFFFCDC00巴莎兰|r
step
	#era/som
    #sticky
    #label threshers
...
step
    ...
    >>手伸进脱粒机的眼睛
    .turnin 1001 >>提交|cFF00FF25传声盒411号|r
    .accept 1002 >>接受|cFFFCDC00传声盒323号|r
step
    .goto Felwood,25.15,4.61
    .accept 4723 >>接受|cFFFCDC00搁浅的海洋生物|r
step
    #completewith mbox
     >>杀死漫游者。掠夺他们以获取“漫游者肉”
...
step
    ...
    .turnin 954 >>提交|cFF00FF25巴莎兰|r
    .accept 955 >>接受|cFFFCDC00巴莎兰|r
step
...
step
    .goto Felwood,27.70,10.03
    .turnin 955 >>提交|cFF00FF25巴莎兰|r
    .accept 956 >>接受|cFFFCDC00巴莎兰|r
step
...
step
    .goto Felwood,27.70,10.03
    .turnin 956 >>提交|cFF00FF25巴莎兰|r
    .accept 957 >>接受|cFFFCDC00巴莎兰|r
step
    .xp 13 >>升级到13级
step
...
step
    .goto Felwood,20.34,18.12
    .turnin 4811 >>提交|cFF00FF25红色水晶|r
    .accept 4812 >>接受|cFFFCDC00清洗水晶|r
step
...
step <<  Hunter/Druid
    .goto Felwood,31.29,24.14
     >>点击红色水晶
    .turnin 4812 >>提交|cFF00FF25清洗水晶|r
    .accept 4813 >>接受|cFFFCDC00水晶中的碎骨|r
step <<  Hunter/Druid
    .goto Felwood,20.34,18.12
    .turnin 4813 >>提交|cFF00FF25水晶中的碎骨|r
step << Druid
    #label darn1
    .goto Felwood,19.27,19.14
    .accept 6343 >>接受|cFFFCDC00飞回泰达希尔|r
step << Druid
    #era
    .goto Felwood,22.39,29.45
    .xp 14-1890 >>刷怪直到距离14级1890xp
step << Druid
    #som
    .goto Felwood,22.39,29.45
    .xp 14-2645 >>刷怪直到距离14级2645xp
step << Druid
    .fly Teldrassil>>飞往Teldrassil
step << Druid
    .goto Teldrassil,56.25,92.44
     >>返回Nessa
    .turnin 6343 >>提交|cFF00FF25飞回泰达希尔|r
step << Druid
    .goto Darnassus,35.4,8.4
    .turnin 6001 >>提交|cFF00FF25身心之力|r
    .accept 6121 >>接受|cFFFCDC00新的课程|r
>>学习职业技能step << Druid
    .goto Moonglade,56.1,30.7
    >>前往: |cFFDB2EEF月光林地|r
    .turnin 6121 >>提交|cFF00FF25新的课程|r
    .accept 6122 >>接受|cFFFCDC00毒水之源|r
step << Druid
    .hs >> 炉石回到旅店CD中就跑回去
...
step
    ...
    .accept 953 >>接受|cFFFCDC00亚米萨兰的毁灭|r
step
    .goto Felwood,19.64,39.52
    .accept 4722 >>接受|cFFFCDC00搁浅的海龟|r
step
    #sticky
    #label anaya
...
step
    ...
    .turnin 953 >>提交|cFF00FF25亚米萨兰的毁灭|r
step << Hunter
    #requires ghosts
     >>杀死分叉
    .goto Felwood,22.39,29.45
...
step
    .goto Felwood,22.24,18.22
    .turnin 985 >>提交|cFF00FF25熊怪的威胁|r
    .accept 986 >>接受|cFFFCDC00丢失的主人|r
step
    .goto Felwood,21.86,18.30
     >>跑上楼去
    .accept 965 >>接受|cFFFCDC00奥萨拉克斯之塔|r
step <<  !Druid !Hunter
...
step
    .goto Felwood,18.10,18.48
    .turnin 963 >>提交|cFF00FF25永志不渝|r
step << !Hunter
    .goto Felwood,19.10,20.63
    .turnin 4722 >>提交|cFF00FF25搁浅的海龟|r
step
    .goto Felwood,18.50,19.87
    .accept 1138 >>接受|cFFFCDC00海中的水果|r
...
step << !NightElf
    .goto Felwood,20.80,15.58
    .turnin 982 >>提交|cFF00FF25深不可测的海洋|r
step
    #completewith next
    .goto Felwood,20.80,15.58
...
step <<  NightElf
    .goto Felwood,19.98,14.40
    .turnin 958 >>提交|cFF00FF25上层精灵的工具|r
step << !Druid !Hunter
    .goto Felwood,31.29,24.14
     >>点击红色水晶
    .turnin 4812 >>提交|cFF00FF25清洗水晶|r
...
step
    ...
    .accept 4725 >>接受|cFFFCDC00搁浅的海龟|r
step
    #sticky
    #completewith mbox
     >>杀死沿海的珊瑚虫，不要特意完成这个任务
...
step
    ...
    .goto Winterspring,1.42,26.89
     >>如果你没有足够的潜月者毒牙，跳过这一步
    .turnin 1002 >>提交|cFF00FF25传声盒323号|r
    .accept 1003 >>接受|cFFFCDC00传声盒525号|r
step << NightElf Hunter/Druid
    .goto Winterspring,4.82,27.18
    .turnin 965 >>提交|cFF00FF25奥萨拉克斯之塔|r
    .accept 966 >>接受|cFFFCDC00奥萨拉克斯之塔|r
step << NightElf Hunter/Druid
...
step << NightElf Hunter/Druid
    .goto Winterspring,4.82,27.18
    .turnin 966 >>提交|cFF00FF25奥萨拉克斯之塔|r
    .accept 967 >>接受|cFFFCDC00奥萨拉克斯之塔|r
step
...
step <<  NightElf !Druid
    #softcore
    #completewith next
     .deathskip >>刷怪直到你的高速冷却时间<6分钟，然后死亡扭曲到奥伯丁
step <<  NightElf !Druid
    #hardcore
    #completewith next
     +刷怪直到你的HS冷却时间<9分钟，然后跑回奥伯丁
step <<  !NightElf
     #completewith next
    .hs >> 炉石回到旅店CD中就跑回去
step <<  !NightElf
    .goto Felwood,20.04,16.35
    .accept 729 >>接受|cFFFCDC00健忘的勘察员|r
step <<  !NightElf
    .goto Felwood,19.98,14.40
    .turnin 958 >>提交|cFF00FF25上层精灵的工具|r
step
    .goto Darkshore,37.70,40.70
    .accept 2178 >>接受|cFFFCDC00炖陆行鸟|r
    .turnin 2178 >>提交|cFF00FF25炖陆行鸟|r
    >>这个任务需要烹饪10分
step
    .goto Felwood,19.98,14.40
    .turnin 4762 >>提交|cFF00FF25壁泉河|r
    .accept 4763 >>接受|cFFFCDC00黑木熊怪的堕落|r
step << Druid
    .goto Darkshore,37.7,40.7
    .turnin 6122 >>提交|cFF00FF25毒水之源|r
    .accept 6123 >>接受|cFFFCDC00收集解药|r
step
    .goto Felwood,20.80,15.58
    .turnin 982 >>提交|cFF00FF25深不可测的海洋|r
step
...
step
    .goto Felwood,19.90,18.40
    .turnin 947 >>提交|cFF00FF25洞中的蘑菇|r
    .accept 948 >>接受|cFFFCDC00安努|r
step
    .goto Felwood,19.78,19.07
     >>点击酒店外的通缉海报
    .accept 4740 >>接受|cFFFCDC00通缉：莫克迪普！|r
step
    #sticky
    #label bowl
    .goto Darkshore,37.78,44.06
...
step
    ...
    #requires bowl
    .goto Felwood,19.10,20.63
    .turnin 4723 >>提交|cFF00FF25搁浅的海洋生物|r
    .turnin 4725 >>提交|cFF00FF25搁浅的海龟|r
    .turnin 4722 >>提交|cFF00FF25搁浅的海龟|r
step <<  Druid
    .goto Felwood,22.39,29.45
    .xp 16
...
step << Druid
    ...
    .accept 730 >>接受|cFFFCDC00黑海岸的麻烦事|r
step << Druid
    .goto Moonglade,56.1,30.7
    >>前往: |cFFDB2EEF月光林地|r
    .turnin 26 >>提交|cFF00FF25必修的课程|r
    .accept 29 >>接受|cFFFCDC00湖中试炼|r
step << Druid
...
step << Druid
    ...
    .turnin 29 >>提交|cFF00FF25湖中试炼|r
    .accept 272 >>接受|cFFFCDC00海狮试炼|r
step << Druid
    .hs >> 炉石回到旅店CD中就跑回去
]])
...
step << Human
    ...
    .turnin 6285 >>提交|cFF00FF25返回西部荒野|r
step << Gnome/Dwarf
    #completewith next
...
step
    ...
    .turnin 151 >>提交|cFF00FF25老马布兰契|r
    .turnin 64 >>提交|cFF00FF25遗失的怀表|r
step
    #som
    #requires Pawbs
    .goto Westfall,59.91,19.41
...
step
	...
	.target Farmer Saldean
    .goto Westfall,56.00,31.30
    .turnin 9 >>提交|cFF00FF25清理荒野|r
step
	>>与|cFF00FF25Salma Saldean|r。
	.target Salma Saldean
    .goto Westfall,56.40,30.50
    .turnin 38 >>提交|cFF00FF25杂味炖肉|r
    .turnin 22 >>提交|cFF00FF25猪肝馅饼|r
step
	>>与|cFF00FF25Gryan Stoutmantle交谈。
	.target Gryan Stoutmantle
    .goto Westfall,56.30,47.50
    .turnin 12 >>提交|cFF00FF25西部荒野人民军|r
step
	.xp <15,1
	>>与|cFF00FF25Gryan Stoutmantle交谈。
	.target Gryan Stoutmantle
    .goto Westfall,56.30,47.50
    .accept 65 >>接受|cFFFCDC00迪菲亚兄弟会|r
step
    #era
	>>与|cFF00FF25 Danuvin船长交谈。
	.target Captain Danuvin
    .goto Westfall,56.30,47.50
    .turnin 102 >>提交|cFF00FF25西部荒野的豺狼人|r
step
	>>与|cFF00FF25Scout Galiaan|r交谈。
	.target Scout Galiaan
    .goto Westfall,54.00,52.90
    .turnin 153 >>提交|cFF00FF25红色皮质面罩|r
...
>>学习职业技能step << Dwarf Paladin
    ...
    >>和楼上的缪尔登谈谈
    .turnin 1784 >>提交|cFF00FF25圣洁之书|r
    .accept 1785 >>接受|cFFFCDC00圣洁之书|r
step << Dwarf Paladin
    .goto Ironforge,27.4,11.9
    .turnin 1785 >>提交|cFF00FF25圣洁之书|r
step << Dwarf Paladin
    #softcore
...
step << NightElf
     #completewith next
    .goto Felwood,20.04,16.35
    .turnin 730 >>提交|cFF00FF25黑海岸的麻烦事|r
step
    .goto Felwood,20.04,16.35
     >>心不在焉的探矿者
    .accept 729 >>接受|cFFFCDC00健忘的勘察员|r
...
step
    ...
    .turnin 952 >>提交|cFF00FF25古树之林|r
    .turnin 948 >>提交|cFF00FF25安努|r
    .accept 944 >>接受|cFFFCDC00主宰之剑|r
step
...
step
    #sticky
    .goto Ashenvale,22.36,3.98
    .accept 945 >>接受|cFFFCDC00护送瑟瑞露尼|r
step
     >>把烤鸡蛋的碗扔在地上
    .turnin 944 >>提交|cFF00FF25主宰之剑|r
    .accept 949 >>接受|cFFFCDC00暮光之锤的营地|r
step
    .goto Ashenvale,22.24,2.52
     >>点击底座顶部的书籍
    .turnin 949 >>提交|cFF00FF25暮光之锤的营地|r
    .accept 950 >>接受|cFFFCDC00向安努回复|r
step
    >>完成护送任务
    .complete 945,1
step
    ...
    .turnin 1003 >>提交|cFF00FF25传声盒525号|r
    .isOnQuest 1003
step
    .goto Felwood,27.00,55.59
    .turnin 950 >>提交|cFF00FF25向安努回复|r
    .accept 951 >>接受|cFFFCDC00玛塞斯特拉遗物|r
step << Hunter
    .xp 17
step << Hunter
    #sticky
    ...
    .turnin 729 >>提交|cFF00FF25健忘的勘察员|r
step <<  Hunter
    .goto Darkshore,35.72,83.69
     >>开始护送任务
     >>这个任务非常困难，你可以跳过这一步，稍后在19级时再回来
    .accept 731,1 >>接受|cFFFCDC00健忘的勘察员|r
...
step << Hunter
    ...
    .accept 4733 >>接受|cFFFCDC00搁浅的海洋生物|r
...
step << Hunter
    ...
    .accept 4732 >>接受|cFFFCDC00搁浅的海龟|r
step << Hunter
	#era/som << Dwarf
    .goto Felwood,13.47,64.01
    .accept 4731 >>接受|cFFFCDC00搁浅的海龟|r
step << Hunter
	#era/som << Dwarf
    .goto Felwood,14.62,60.72
    .accept 4730 >>接受|cFFFCDC00搁浅的海洋生物|r
step
    #completewith south2
...
step
    ...
    .accept 4728 >>接受|cFFFCDC00搁浅的海洋生物|r
step << !Druid
    .goto Felwood,19.64,39.52
    .accept 4722 >>接受|cFFFCDC00搁浅的海龟|r
step << Druid
...
step
    ...
    .turnin 4722 >>提交|cFF00FF25搁浅的海龟|r
    .turnin 4728 >>提交|cFF00FF25搁浅的海洋生物|r
step << Hunter
	#era/som << Dwarf
    .goto Darkshore,36.62,45.59
...
step
    #label south2
    .goto Felwood,18.50,19.87
    .turnin 1138 >>提交|cFF00FF25海中的水果|r
    >>如果您尚未收集全部6项，请跳过此步骤
...
step
    .goto Felwood,21.63,18.15
    .turnin 2138 >>提交|cFF00FF25清除疫病|r
    .accept 2139 >>接受|cFFFCDC00萨纳瑞恩的希望|r
step << Hunter
    .goto Felwood,20.04,16.35
...
step << Druid
    .goto Darkshore,37.7,40.7
    .turnin 6123 >>提交|cFF00FF25收集解药|r
    .accept 6124 >>接受|cFFFCDC00消除疾病|r
step
    .goto Felwood,27.70,10.03
    .turnin 957 >>提交|cFF00FF25巴莎兰|r
step << Druid
...
step  << !Warrior !Paladin !Rogue !Druid
    ...
    .accept 2098 >>接受|cFFFCDC00基尔卡克的钥匙|r
step  << !Warrior !Paladin !Rogue !Druid
    #sticky
...
step  << !Warrior !Paladin !Rogue !Druid
    ...
    .goto Winterspring,6.37,16.66
    .turnin 2098 >>提交|cFF00FF25基尔卡克的钥匙|r
    .accept 2078 >>接受|cFFFCDC00基尔卡克的报复|r
step << !Druid
    .goto Winterspring,3.10,20.90
    .accept 4727 >>接受|cFFFCDC00搁浅的海龟|r
step << !Druid
...
step  << !Warrior !Paladin !Rogue !Druid
    .goto Winterspring,6.37,16.66
    .turnin 2078 >>提交|cFF00FF25基尔卡克的报复|r
...
step <<  Dwarf Hunter
    .goto Felwood,19.98,14.40
    .turnin 4763 >>提交|cFF00FF25黑木熊怪的堕落|r
step <<  Dwarf Hunter
    .goto Felwood,21.63,18.15
    .turnin 2139 >>提交|cFF00FF25萨纳瑞恩的希望|r
step << Dwarf Hunter
...
step << Druid
    ...
    >>前往: |cFFDB2EEF月光林地|r
    .turnin 6124 >>提交|cFF00FF25消除疾病|r
    .accept 6125 >>接受|cFFFCDC00解毒之术|r
step << Druid
...
step
    .goto Felwood,19.10,20.63
    .turnin 4727 >>提交|cFF00FF25搁浅的海龟|r
step
    .goto Felwood,18.50,19.87
    .turnin 1138 >>提交|cFF00FF25海中的水果|r
step
...
step
    ...
    .turnin 986 >>提交|cFF00FF25丢失的主人|r
    .accept 993 >>接受|cFFFCDC00丢失的主人|r
 step <<  !Hunter
...
step << !Hunter
    ...
    .accept 250 >>接受|cFFFCDC00水坝危机|r
step << !Hunter
    .goto Loch Modan,56.1,13.3
    >>点击小炸药桶
    .turnin 250 >>提交|cFF00FF25水坝危机|r
    .accept 199 >>接受|cFFFCDC00水坝危机|r
step << !Hunter
    .goto Loch Modan,46.0,13.3
    .turnin 199 >>提交|cFF00FF25水坝危机|r
step <<  !Hunter
    #completewith next
...
step
	...
	#phase 3-6
    .goto Darkshore,61.40,9.40
     >>刷怪|cFF00BCD4追踪器Sires/Matriarchs|r，用于|cFF00BCD4四肢和牙齿|r
...
step <<  NightElf
     #softcore
    #completewith next
    .deathskip >>刷怪直到你的炉石冷却时间<6分钟，然后死亡扭曲到奥伯丁
step <<  NightElf
     #hardcore
    #completewith next
    +刷怪直到你的炉石冷却时间<9分钟，然后跑回奥伯丁
step
     #completewith next
    .hs >> 炉石回到旅店CD中就跑回去
step
...
step
    ...
    .turnin 993 >>提交|cFF00FF25丢失的主人|r
step
	#era/som
     >>在接受这个任务之前，清除洞穴附近的裂谷
    .accept 994 >>接受|cFFFCDC00杀出重围|r
step
	#som
	#phase 3-6
     >>接受请求并等待RP序列完成
    .accept 995 >>接受|cFFFCDC00偷偷溜走|r
step
	#era/som
...
step
    .goto Felwood,27.00,55.59
    .turnin 951 >>提交|cFF00FF25玛塞斯特拉遗物|r
step
    .goto Felwood,27.96,55.76
    >>与科隆尼安对话，开始护送任务
    >>如果他不在，你可以跳过这个任务(根据其他玩家的不同，重生最多需要25分钟)
    .accept 5321 >>接受|cFFFCDC00昏昏欲睡|r
step
    .isOnQuest 5321
...
step
    .goto Ashenvale,27.26,35.58
    .turnin 5321 >>提交|cFF00FF25昏昏欲睡|r
    .isQuestComplete 5321
step
    #label tower
    .goto Ashenvale,26.19,38.69
    .turnin 967 >>提交|cFF00FF25奥萨拉克斯之塔|r
step
	#era/som
    .goto Ashenvale,26.19,38.69
    .accept 970 >>接受|cFFFCDC00奥萨拉克斯之塔|r
step
	#era/som
     #completewith next
...
step
	#era/som
     #completewith next
    .goto Ashenvale,26.19,38.69
    .turnin 970 >>提交|cFF00FF25奥萨拉克斯之塔|r
step
    .xp 20 >>升级到20级
step
    .goto Ashenvale,26.43,38.59
    .accept 1010 >>接受|cFFFCDC00巴斯兰的头发|r
step
...
step
    ...
    #label hair
    .goto Ashenvale,26.43,38.59
    .turnin 1010 >>提交|cFF00FF25巴斯兰的头发|r
    .accept 1020 >>接受|cFFFCDC00奥雷迪尔的药剂|r
step
	#era/som
    .goto Ashenvale,26.43,38.59
    .turnin 970 >>提交|cFF00FF25奥萨拉克斯之塔|r
    .accept 973 >>接受|cFFFCDC00奥萨拉克斯之塔|r
step
    #requires hair
...
step
    ...
    .accept 1008 >>接受|cFFFCDC00佐拉姆海岸|r
step
    .goto Ashenvale,34.89,49.79
    .accept 1070 >>接受|cFFFCDC00守卫石爪山|r
step
    .goto Ashenvale,35.76,49.10
    .accept 1056 >>接受|cFFFCDC00石爪峰之旅|r
step
    .goto Ashenvale,36.61,49.58
    .accept 991 >>接受|cFFFCDC00莱恩的净化|r
    .accept 1054 >>接受|cFFFCDC00解除威胁|r
step <<  !Dwarf/!Hunter
    .home >>将HS设置为Astranaar
step
    .goto Ashenvale,37.36,51.79
    .turnin 1020 >>提交|cFF00FF25奥雷迪尔的药剂|r
...
>>学习职业技能step << Paladin
    ...
    .turnin 1641 >>提交|cFF00FF25圣洁之书|r
    .collect 6775,1,1642 --Tome of Divinity (1)
    .accept 1642 >>接受|cFFFCDC00圣洁之书|r
    .turnin 1642 >>提交|cFF00FF25圣洁之书|r
    .accept 1643 >>接受|cFFFCDC00圣洁之书|r
step << Paladin
    .goto StormwindClassic,38.68,32.85
>>学习职业技能step << Priest !NightElf
    .goto StormwindClassic,38.54,26.86
>>学习职业技能step << Rogue !NightElf
    .goto StormwindClassic,74.64,52.82
>>学习职业技能step << Warrior !NightElf
    >>进入指挥中心
...
step << Paladin
    ...
    .turnin 1643 >>提交|cFF00FF25圣洁之书|r
    .accept 1644 >>接受|cFFFCDC00圣洁之书|r
    .turnin 1644 >>提交|cFF00FF25圣洁之书|r
--  .accept 1780 >>接受|cFFFCDC00圣洁之书|r
step << Rogue
...
>>学习职业技能step << NightElf Rogue/NightElf Priest
    >>进客栈，然后上楼
...
>>学习职业技能step << !Human !Warlock
    #som
    #phase 3-6
    #level 20
    >>跑向阿佐拉塔
    .goto Elwynn Forest,65.20,69.80
    .accept 94 >>接受|cFFFCDC00法师的眼线|r
step << NightElf
    #era/som
    #level 20
    >>跑向阿佐拉塔
...
step
	...
	.target Darcy
    .accept 129 >>接受|cFFFCDC00免费的午餐|r
step
    .goto Redridge Mountains,26.6,45.2
    >>上楼去和黑人威利谈谈
	.target Wiley the Black
    .turnin 65 >>提交|cFF00FF25迪菲亚兄弟会|r
    .isOnQuest 65
step
    #era/som
...
step
    ...
    .accept 3741 >>接受|cFFFCDC00希拉里的项链|r
step
...
step
	...
	.target Guard Parker
    .goto Redridge Mountains,15.27,71.45
    .turnin 129 >>提交|cFF00FF25免费的午餐|r
    .accept 130 >>接受|cFFFCDC00寻访草药师|r
step
...
step
    #era
    .xp 20-6300 >>刷怪直到距离20级6300 xp
step
    #som
    .xp 20-8800 >>刷怪，直到距离20级8800 xp
step << skip
     #softcore
     #completewith next
     .deathskip >>故意死在墓地
...
step << Warlock
    .goto StormwindClassic,26.11,77.20
>>学习职业技能    .goto StormwindClassic,25.30,78.50
    .accept 1716 >>接受|cFFFCDC00噬魂者|r
step << Mage
    .goto StormwindClassic,37.69,82.09,10 >>爬上塔楼，然后穿过入口
>>学习职业技能step << Mage
...
>>学习职业技能step
    ...
    .accept 3765 >>接受|cFFFCDC00遥远的旅途|r
step << Druid
...
>>学习职业技能step << Paladin
    ...
    .accept 1649 >>接受|cFFFCDC00勇气之书|r
    .turnin 1649 >>提交|cFF00FF25勇气之书|r
    .accept 1650 >>接受|cFFFCDC00勇气之书|r
step << Paladin
    .goto StormwindClassic,38.68,32.85
>>学习职业技能step << Priest
    .goto StormwindClassic,42.66,33.75,30,0
...
>>学习职业技能    .accept 2281 >>接受|cFFFCDC00赤脊山的联络员|r
    .accept 2360 >>接受|cFFFCDC00马迪亚斯和迪菲亚潜行者|r
step << Warrior
    >>进入指挥中心
    .goto StormwindClassic,74.91,51.55,20,0
    .goto StormwindClassic,78.67,45.80
>>学习职业技能step
    ...
    .turnin 120 >>提交|cFF00FF25送往暴风城的信|r
    .accept 121 >>接受|cFFFCDC00送往暴风城的信|r
step
    .goto Elwynn Forest,41.80,65.60
    >>离开暴风城，前往戈德郡，与|cFF00FF25Smith Argus|r交谈
	.target Smith Argus
    .turnin 118 >>提交|cFF00FF25马掌|r
    .accept 119 >>接受|cFFFCDC00回复弗纳|r
step
    >>跑向阿佐拉塔
    .goto Elwynn Forest,65.20,69.80
    .accept 94 >>接受|cFFFCDC00法师的眼线|r
...
step
    ...
    .turnin 125 >>提交|cFF00FF25丢失的工具|r
    .accept 89 >>接受|cFFFCDC00止水湖上的桥|r
step
	>>与|cFF00FF25Verner Osgood|r交谈
	.target Verner Osgood
    .goto Redridge Mountains,31.00,47.20
    .turnin 119 >>提交|cFF00FF25回复弗纳|r
    .accept 124 >>接受|cFFFCDC00豺狼人的乱吠|r
step
    #era
	>>与|cFF00FF25Verner Osgood|r交谈
	.target Verner Osgood
    .goto Redridge Mountains,31.00,47.20
    .accept 122 >>接受|cFFFCDC00雏龙的鳞片|r
step
    #label FlyR
	>>与|cFF00FF25治安官Soloman|r交谈
	.target Magistrate Soloman
    .goto Redridge Mountains,29.98,44.45
    .turnin 121 >>提交|cFF00FF25送往暴风城的信|r
step
	>>与|cFF00FF25Hilary交谈|r
	.target Hilary
    .goto Redridge Mountains,29.20,53.60
     .turnin 3741 >>提交|cFF00FF25希拉里的项链|r
step << Rogue
    .goto Redridge Mountains,28.07,52.02
    .turnin 2281 >>提交|cFF00FF25赤脊山的联络员|r
    .accept 2282 >>接受|cFFFCDC00奥瑟尔伐木场|r
step
...
step
    ...
    .turnin 92 >>提交|cFF00FF25赤脊山炖肉|r
step
	>>与|cFF00FF25Martie Jainrose|r交谈
	.target Martie Jainrose
    .goto Redridge Mountains,21.90,46.20
    .turnin 130 >>提交|cFF00FF25寻访草药师|r
    .accept 131 >>接受|cFFFCDC00水仙诉衷情|r
step
    #era
	#completewith next
...
step
    ...
    .turnin 131 >>提交|cFF00FF25水仙诉衷情|r
step
    #era
...
step
    ...
    .turnin 124 >>提交|cFF00FF25豺狼人的乱吠|r
    .turnin 122 >>提交|cFF00FF25雏龙的鳞片|r
step
    #som
	>>与|cFF00FF25Verner Osgood|r交谈
	.target Verner Osgood
...
step << Rogue
	...
	.target Lucius
    .goto Redridge Mountains,28.07,52.02
    .turnin 2282 >>提交|cFF00FF25奥瑟尔伐木场|r
step << Rogue
	#completewith next
...
step
    ...
    .turnin 89 >>提交|cFF00FF25止水湖上的桥|r
step << Rogue
    #softcore
