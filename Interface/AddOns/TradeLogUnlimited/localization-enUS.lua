...
CANCEL_REASON_TEXT = {
	self = "I cancelled the trade",
	other = "player cancelled the trade",
	toofar = "we are too faraway",
	selfrunaway = "Out of range",
	selfhideui = "I hid ui",
	unknown = "unknown reason",
}

TRADE_LOG_SUCCESS_NO_EXCHANGE = "Trade with >%t< was COMPLETED, but no exchange made.";
TRADE_LOG_SUCCESS = "Traded >%t<";
TRADE_LOG_DETAIL = " Details";
TRADE_LOG_CANCELLED = "Trade with > %t< was CANCELLED: %r.";
TRADE_LOG_FAILED = "Trade with >%t< FAILED: %r.";
TRADE_LOG_FAILED_NO_TARGET = "Trade FAILED: %r.";
TRADE_LOG_HANDOUT = " I gave: " ;
TRADE_LOG_RECEIVE = " I received: ";
